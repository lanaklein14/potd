...
class DDManager {
    constructor() {
        ...
        this.rooms = [
            ...
            new Room(181, -363, 217, -327, 'A4', [{x:204.62,y:-341.65}], []),
            ...
            new Room(225, -305, 259, -270, 'A10', [{x:246.14,y:-284.84}/*確定*/], []),
            ...
            new Room(351, -272, 385, -236, 'A17', [{x:373.86,y:-248.43}/*確定*/], [{x:372,y:-247.4}]),
            ...
            new Room(-306, 163, -270, 206, 'B1', [{x:-282.86,y:187.42}], [{x:-287.57,y:183.84}]),
            new Room(-393, 170, -357, 206, 'B2', [{x:-376.71,y:187.8},{x:-373.73,y:189.42}/*確定*/], []),
            ...
            new Room(-375, 340, -337, 376, 'B15', [{x:-343.97,y:367.27}], []),
