...
const layout191_200 = new Layout([
    ...
    new Room('A5', 235, -364, 275, -328, true), //
    new Room('A6', 294, -376, 328, -341), //
    new Room('A7', 350, -364, 386, -328, true), //
    new Room('A8', 409, -383, 444, -338, true), //
    new Room('A9', 173, -319, 202, -285), //
    new Room('A10', 228, -306, 262, -273), //
    new Room('A11', 285, -316, 317, -283), //
    new Room('A12', 334, -316, 370, -290, true), //
    new Room('A13', 387, -331, 425, -295), //
    new Room('A14', 175, -253, 205, -220), //
    new Room('A15', 230, -264, 263, -230), //
    new Room('A16', 282, -265, 316, -230), //
    new Room('A17', 336, -276, 383, -235), //
    ...
    new Room('B4', -434, 225, -404, 262, true), //
    new Room('B5', -382, 229, -349, 261 ), //
    ...
    new Room('B11', -318, 286, -283, 321, true), //
    new Room('B12', -260, 296, -217, 334, true), //
